...
${OBJECTDIR}/src/discorde_cpp.o: src/discorde_cpp.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../c/src -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/discorde_cpp.o src/discorde_cpp.cpp

# Subprojects
.build-subprojects:
	cd ../c && ${MAKE}  -f Makefile CONF=Release
...
# Subprojects
.clean-subprojects:
	cd ../c && ${MAKE}  -f Makefile CONF=Release clean
