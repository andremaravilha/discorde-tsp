...
int
    ...
    CCtsp_clique_delta (CCtsp_lpgraph *g, double *x, CCtsp_lpclique *c,
        double *delta),
    CCtsp_copy_lpcut_in (CCtsp_lpcut_in *c, CCtsp_lpcut_in *_new),
    ...
    CCtsp_lpcut_to_lpcut_in (CCtsp_lpcuts *cuts, CCtsp_lpcut *c,
        CCtsp_lpcut_in *_new),
    CCtsp_copy_lpclique (CCtsp_lpclique *c, CCtsp_lpclique *_new),
    CCtsp_copy_lpdomino (CCtsp_lpdomino *c, CCtsp_lpdomino *_new),
...
int
    CCtsp_copy_skeleton (CCtsp_skeleton *old, CCtsp_skeleton *_new),
...
int
    ...
    CCverify_classify (CCtsp_lpcut_in *cut, int check_types,
        CCverify_cutclass *_class);

void
    CCverify_initcutclass (CCverify_cutclass *_class),
    CCverify_freecutclass (CCverify_cutclass *_class);
